...
class Ui_BBUI(object):
    def setupUi(self, BBUI):
        ...
        self.gridLayout_10.addWidget(self.comboBox, 0, 4, 1, 1)
        self.lineEdit_3 = QtWidgets.QLineEdit(self.mapping_view_frame)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.gridLayout_10.addWidget(self.lineEdit_3, 0, 7, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.mapping_view_frame)
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridLayout_10.addWidget(self.line_2, 0, 9, 1, 1)
        self.comboBox_3 = QtWidgets.QComboBox(self.mapping_view_frame)
        self.comboBox_3.setObjectName("comboBox_3")
        self.gridLayout_10.addWidget(self.comboBox_3, 0, 12, 1, 1)
        self.lineEdit_4 = QtWidgets.QLineEdit(self.mapping_view_frame)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.gridLayout_10.addWidget(self.lineEdit_4, 0, 11, 1, 1)
        self.line = QtWidgets.QFrame(self.mapping_view_frame)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayout_10.addWidget(self.line, 0, 5, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.mapping_view_frame)
        self.label_3.setObjectName("label_3")
        self.gridLayout_10.addWidget(self.label_3, 0, 10, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.mapping_view_frame)
        self.label_4.setObjectName("label_4")
        self.gridLayout_10.addWidget(self.label_4, 1, 2, 1, 1)
        self.lineEdit_5 = QtWidgets.QLineEdit(self.mapping_view_frame)
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.gridLayout_10.addWidget(self.lineEdit_5, 1, 3, 1, 1)
        self.comboBox_4 = QtWidgets.QComboBox(self.mapping_view_frame)
        self.comboBox_4.setObjectName("comboBox_4")
        self.gridLayout_10.addWidget(self.comboBox_4, 1, 4, 1, 1)
        self.line_3 = QtWidgets.QFrame(self.mapping_view_frame)
        self.line_3.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout_10.addWidget(self.line_3, 1, 5, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.mapping_view_frame)
        self.label_5.setObjectName("label_5")
        self.gridLayout_10.addWidget(self.label_5, 1, 6, 1, 1)
        self.lineEdit_6 = QtWidgets.QLineEdit(self.mapping_view_frame)
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.gridLayout_10.addWidget(self.lineEdit_6, 1, 7, 1, 1)
        self.comboBox_5 = QtWidgets.QComboBox(self.mapping_view_frame)
        self.comboBox_5.setObjectName("comboBox_5")
        self.gridLayout_10.addWidget(self.comboBox_5, 1, 8, 1, 1)
        self.line_4 = QtWidgets.QFrame(self.mapping_view_frame)
        self.line_4.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.gridLayout_10.addWidget(self.line_4, 1, 9, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.mapping_view_frame)
        self.label_6.setObjectName("label_6")
        self.gridLayout_10.addWidget(self.label_6, 1, 10, 1, 1)
        self.lineEdit_7 = QtWidgets.QLineEdit(self.mapping_view_frame)
        self.lineEdit_7.setObjectName("lineEdit_7")
        self.gridLayout_10.addWidget(self.lineEdit_7, 1, 11, 1, 1)
        self.comboBox_6 = QtWidgets.QComboBox(self.mapping_view_frame)
        self.comboBox_6.setObjectName("comboBox_6")
        self.gridLayout_10.addWidget(self.comboBox_6, 1, 12, 1, 1)
        self.label_7_name = QtWidgets.QLabel(self.mapping_view_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_7_name.sizePolicy().hasHeightForWidth())
        ...
        self.verticalLayout_page_3_3_3.addItem(spacerItem6)
        ...
        self.horizontalLayout_page_3_2_2.addItem(spacerItem7)
    ...
    def retranslateUi(self, BBUI):
        ...
        self.label_3.setText(_translate("BBUI", "TextLabel"))
        self.label_4.setText(_translate("BBUI", "TextLabel"))
        self.label_5.setText(_translate("BBUI", "TextLabel"))
        self.label_6.setText(_translate("BBUI", "TextLabel"))
        self.label_7_name.setText(_translate("BBUI", "TextLabel"))
        ...
        self.label_7.setText(_translate("BBUI", "TextLabel"))
